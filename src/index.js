...
const onClickAdd = () => {
  ...
  completeButton.addEventListener("click", () => {
    ...
    backButton.addEventListener("click", () => {
      ...
      const addBackTarget = backButton.parentNode;
      const backText = addBackTarget.firstElementChild.innerText;

      addBackTarget.textContent = null;

      const li = document.createElement("li");
      li.innerText = backText;

      addBackTarget.appendChild(li);
